...
public class Gen2Constants {
    ...
    public static final List<Integer> bannedLevelupMoves = Arrays.asList(168, 194);

    public static final List<Integer> brokenMoves = Arrays.asList(49, 82, 32, 90, 12, 194);
